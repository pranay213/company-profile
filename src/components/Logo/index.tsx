...
const ByteAnchorLogo = () => {
    ...
    // Original colors with hover variants
    const colors = {
    ...
    return (
        <>
            {/* Load the new font from Typekit */}
            <link rel="stylesheet" href="https://use.typekit.net/oyo8exc.css" />
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 200" width="300">
                    ...
                    {/* Byte Anchor Text with new font */}
                    <motion.text
                        x="150"
                        y="115"
                        fontSize="45"
                        ...
                        letterSpacing={'2px'}
                        fontFamily="your-new-font, sans-serif"  // Replace with actual Typekit font name
